...
class BillsHistory:
    ...
    def save(self, bills_data: BillsData) -> None:
    ...
    def get_by_month(self, year: int, month: int) -> list[dict[str, Any]]:
        return [item for item in self.load_all() if item.get("year") == year and item.get("month") == month]
